...
swiftc Sources/Vorssaint/Services/NetworkInfo/NetworkInfoLocalAddresses.swift Sources/Vorssaint/Services/NetworkInfo/NetworkInfoSupport.swift Sources/Vorssaint/Services/NetworkInfo/NetworkInfoService.swift Sources/Vorssaint/Services/NetworkInfo/NetworkInfoHistory.swift Tests/NetworkInfoTests.swift -o "$network_test_dir/network-info"
