...
struct CommandBarFeatureStrings {
    ...
    let sourceMoveUp: String
    let sourceMoveDown: String
    let sourceOrderReset: String
...
extension CommandBarFeatureStrings {
    static let enUS = CommandBarFeatureStrings(
        ...
        sourceOrderReset: "Restore automatic order",
        sourcesCaption: "Switch sources on or off. Move them to set search result order; matches within each source stay ranked by relevance.",
    ...
    static let ptBR = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "Mover para cima",
        sourceMoveDown: "Mover para baixo",
        sourceOrderReset: "Restaurar ordem automática",
        sourcesCaption: "Ative ou desative fontes. Mova-as para ordenar resultados; cada fonte mantém a ordem por relevância.",
    ...
    static let tr = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "Yukarı taşı",
        sourceMoveDown: "Aşağı taşı",
        sourceOrderReset: "Otomatik sıralamayı geri yükle",
        sourcesCaption: "Kaynakları açın veya kapatın. Sonuç sırası için taşıyın; her kaynakta alaka sırası korunur.",
    ...
    static let ru = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "Выше",
        sourceMoveDown: "Ниже",
        sourceOrderReset: "Автоматический порядок",
        sourcesCaption: "Включайте и отключайте источники. Меняйте их порядок; внутри источника результаты идут по релевантности.",
    ...
    static let es = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "Subir",
        sourceMoveDown: "Bajar",
        sourceOrderReset: "Restaurar orden automático",
        sourcesCaption: "Activa o desactiva fuentes y cambia su orden. Dentro de cada fuente se conserva la relevancia.",
    ...
    static let de = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "Nach oben",
        sourceMoveDown: "Nach unten",
        sourceOrderReset: "Automatische Reihenfolge",
        sourcesCaption: "Quellen ein- oder ausschalten und ihre Reihenfolge ändern. Innerhalb jeder Quelle zählt die Relevanz.",
    ...
    static let fr = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "Monter",
        sourceMoveDown: "Descendre",
        sourceOrderReset: "Rétablir l’ordre automatique",
        sourcesCaption: "Activez ou désactivez les sources et réordonnez-les. Chaque source conserve le classement par pertinence.",
    ...
    static let it = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "Sposta su",
        sourceMoveDown: "Sposta giù",
        sourceOrderReset: "Ripristina ordine automatico",
        sourcesCaption: "Attiva o disattiva le fonti e riordinale. Ogni fonte mantiene l’ordine per pertinenza.",
    ...
    static let ja = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "上へ",
        sourceMoveDown: "下へ",
        sourceOrderReset: "自動順序に戻す",
        sourcesCaption: "検索元をオン・オフにして順序を変更できます。各検索元内では関連度順を維持します。",
    ...
    static let ko = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "위로",
        sourceMoveDown: "아래로",
        sourceOrderReset: "자동 순서 복원",
        sourcesCaption: "검색 소스를 켜거나 끄고 순서를 바꾸세요. 각 소스 내에서는 관련도순을 유지합니다.",
    ...
    static let zhHans = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "上移",
        sourceMoveDown: "下移",
        sourceOrderReset: "恢复自动排序",
        sourcesCaption: "可开关所有搜索来源。上下移动可调整搜索结果的来源顺序，同一来源内按相关度排序。",
    ...
    static let zhTW = CommandBarFeatureStrings(
        ...
        sourceMoveUp: "上移",
        sourceMoveDown: "下移",
        sourceOrderReset: "恢復自動排序",
        sourcesCaption: "可開關所有搜尋來源。上下移動可調整搜尋結果的來源順序，同一來源內按相關度排序。",
