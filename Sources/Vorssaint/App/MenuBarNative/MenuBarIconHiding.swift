...
extension MenuBarVisibilityApplying {
    func validateAvailability() throws {}
}
...
protocol PrivateMenuBarBridging: AnyObject {
    var signatureEligible: Bool { get }
...
final class MenuBarClientCoreBridgeAdapter: PrivateMenuBarBridging {
    ...
    var signatureEligible: Bool { MenuBarClientCoreBridge.hasEligibleCodeSignature() }
...
final class MenuBarClientCoreVisibilityApplier: MenuBarVisibilityApplying {
    ...
    func validateAvailability() throws {
        guard bridge.signatureEligible else { throw MenuBarIconHidingError.signatureIneligible }
        guard bridge.isAvailable else { throw MenuBarIconHidingError.nativeAPIUnavailable }
    }
    ...
    func applyCollapse(allowing items: MenuBarVisibleItems) async throws {
        ...
        do {
            ...
            hasActiveAssertion = false
            NSLog("Native menu-bar assertion failed: %@", String(describing: error))
            throw MenuBarIconHidingError.nativeOperationFailed
        }
    }
